...
sInput.onkeyup = function (e) {
    if (fuse) {
        ...
        if (results.length !== 0) {
            ...
            resultsAvailable = false;
            var noResultsText = sInput.getAttribute('data-no-results') || 'No results found';
            resList.innerHTML = '<li class="search-no-results">' + noResultsText + '</li>';
            first = last = current_elem = null;
        }
    }
}
